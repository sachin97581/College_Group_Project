...
import AddFamilyForm from '../extraPages/AddFamilyForm'
import AppointmentForm from '../extraPages/AppointmentForm'
import PatientAppointments from '../extraPages/PatientAppointments'
      ...
      <PatientContext>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path='/add-family' element={<AddFamilyForm/>}/>
            <Route path='/add-appointment' element={<AppointmentForm/>}/>
            <Route path='/your-appointments' element={<PatientAppointments/>}/>
          </Routes>
          {/* <Miscarriage /> */}
        </BrowserRouter>
        <Footer/>
